...
// Будьте аккуратны при работе с памятью. 
// Инвариант класса остается тем же 
// (в size хранится размер строки без завершающего 0 символа, str указывает на C-style строку, 
// т. е. с завершающим нулевым символом).

// Требования к реализации: вы можете заводить любые вспомогательные методы или функции, 
// но не реализуйте заново методы из предыдущих заданий — они уже реализованы. 
